...
public class RegisterFullTest {
    ...
    public void registerFullTest() {
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.Email), withText("qwerty"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        2),
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.Email),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("qwerty01@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText12 = onView(
                allOf(withId(R.id.Phone),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText12.perform(replaceText("08123456789"), closeSoftKeyboard());
